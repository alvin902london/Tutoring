<div class="orders index">
	...
	<tr>
		...
		<td><?php echo h($order['Order']['transaction_reference']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($order['Post']['title'], array('controller' => 'posts', 'action' => 'view', $order['Post']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($order['Comment']['title'], array('controller' => 'comments', 'action' => 'view', $order['Comment']['id'])); ?>
		</td>
		<td><?php echo h($order['Order']['address1']); ?>&nbsp;</td>

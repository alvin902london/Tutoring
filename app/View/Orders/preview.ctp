...
<div class="container">
	<div class="row">
		<div class="col-lg-8">
			...
			<div class="row">
				<div class="col-lg-6">	
					<?php echo $this->Form->input('full_address', array(
						'format' => array('before', 'label', 'between', 'input', 'after', 'error'),
						'div' => 'form-group',
						'label' => array(
							'class' => 'control-label',								
							'text' => __('Full Address')
							),
						'between' => '<div class="input-group"><span class="input-group-addon">' . $post['Post']['district'] . ' ' . $post['Post']['estate'] . '</span>',
						'type' => 'text',
				    	'class' => 'form-control',
				    	'placeholder' => __('Block, Floor, Flat'),
				    	'after' => '</div>'
					)); ?>
				</div>
				<div class="col-lg-6">
			...
			<div class="row">
				<div class="col-lg-6">	
					<?php echo $this->Form->input('tel1', array(
						'type' => 'text',
					    'div' => 'form-group',
					    'class' => 'form-control',
					    'label' => array(
				...
				<div class="col-lg-6">
					<?php echo $this->Form->input('tel2', array(
						'type' => 'text',						
					    'div' => 'form-group',
					    'class' => 'form-control',
					    'label' => array(

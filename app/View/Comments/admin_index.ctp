<div class="comments index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('tag1'); ?></th>
			<th><?php echo $this->Paginator->sort('tag2'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($comment['Comment']['tag1']); ?>&nbsp;</td>
		<td><?php echo h($comment['Comment']['tag2']); ?>&nbsp;</td>

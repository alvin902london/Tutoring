<div class="conditions index">
	...
	<tr>
		...
		<td><?php echo h($condition['Condition']['week']); ?>&nbsp;</td>
		<td><?php echo h($condition['Condition']['start']); ?>&nbsp;</td>
		<td><?php echo h($condition['Condition']['indicator']); ?>&nbsp;</td>
		<td><?php echo h($condition['Condition']['end']); ?>&nbsp;</td>
		<td class="actions">
